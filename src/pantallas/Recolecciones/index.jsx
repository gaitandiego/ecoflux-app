    ...
    const actions = [
        {
            ...
            onClick: (event, rowData) => props.navigate(`${ROUTES.RECOLECCIONES}/editar/${rowData.id}`, { state: rowData }),
        },
        {
        ...
        <>
            <div className="main-content-header">
                <div className='d-flex justify-content-between align-items-center'>
                    <h1>{TEXT.RECOLECCIONES_TITULO}</h1>
                    <button onClick={() => props.navigate(ROUTES.RECOLECCIONES_ADD)} className='btn btn-primary boton_estandar'><Icon.Plus className="icon wh-14" /></button>
                </div>
            </div>
            <Row>
                <Col xl={12}>
                    <Tabla data={items} actions={actions} title={TEXT.RECOLECCIONES_TITULO_TABLA} columns={columns} cargando={cargando} />
                </Col>
            </Row>
